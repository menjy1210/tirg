...
if __name__ == '__main__':
    ...
    image = [testset.get_img(44)] # a tensor of shape (3, 224, 224)
    text = [test_queries[44]['mod']['str']] # ['replace pink with green']
    image_input = preprocess(image).unsqueeze(0).to(device)
    text_inputs = torch.cat([clip.tokenize(text[0])]).to(device)
